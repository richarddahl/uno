...
class SQLTriggerBuilder:
    ...
    def with_schema(self, db_schema: str) -> "SQLTriggerBuilder":
        """Set the db_schema for the trigger.
    ...
    def build(self) -> str:
        ...
        return f"""
            ...
            {config.timing} {config.operation} ON {config.db_schema}.{config.table_name}
