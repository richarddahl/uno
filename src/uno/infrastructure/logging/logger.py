...
class LoggerService:
    ...
    def __init__(self, config: LoggingConfig):
        ...
        self._trace_id: contextvars.ContextVar[str] = contextvars.ContextVar(
    ...
    _trace_context_var: contextvars.ContextVar[dict[str, str]] = contextvars.ContextVar(
        "uno_trace_context", default={}
    )
    ...
    def structured_log(
        ...
        **context: object,
        ...
        log_method(
            msg,
            extra={"context": merged_context if merged_context else None},
            exc_info=exc_info,
        )
    ...
    class trace_scope:
        ...
        def __enter__(self):
            self._token = self._logger_service._trace_context_var.set(
                self._trace_context
            )
