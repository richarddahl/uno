...
from uno.infrastructure.di.container import (
    ServiceCollection,
    ServiceResolver,
    ServiceScope,
)
...
class ServiceProvider:
    ...
    def get_vector_config(self) -> VectorConfigServiceProtocol:
        ...
        from uno.infrastructure.di.vector_interfaces import VectorConfigServiceProtocol
    ...
    def get_vector_update_service(self) -> VectorUpdateServiceProtocol:
        ...
        """
        # Import here to avoid circular imports
        from uno.infrastructure.di.vector_interfaces import VectorUpdateServiceProtocol
    ...
    def get_batch_vector_update_service(self) -> BatchVectorUpdateServiceProtocol:
        ...
        """
        # Import here to avoid circular imports
        from uno.infrastructure.di.vector_interfaces import BatchVectorUpdateServiceProtocol
    ...
    def get_vector_search_service(
        ...
        """
        # Import here to avoid circular imports
        from uno.infrastructure.di.vector_interfaces import VectorSearchServiceFactoryProtocol
    ...
    def get_rag_service(
        ...
        """
        # Import here to avoid circular imports
        from uno.infrastructure.di.vector_interfaces import RAGServiceFactoryProtocol
...
"""
uno.infrastructure.di.provider
...
async def configure_base_services() -> None:
    ...
    services.add_singleton(LoggerService, implementation=LoggerService, config=logging_config)
