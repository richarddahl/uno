...
class RestoredEvent(DomainEvent):
    ...
    restored_by: str | None = Field(default=None, description="Who performed the restoration.")
    reason: str | None = Field(default=None, description="Reason for restoration, if any.")
