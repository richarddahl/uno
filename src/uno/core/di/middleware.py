...
class MiddlewareRegistry(Protocol):
    ...
    def register_middleware_for_event_type(self, event_type: str, middleware: Any) -> None:
...
class MiddlewareBuilder:
    ...
    def add_standard_middleware(self, event_types: list[str] | None = None) -> "MiddlewareBuilder":
        """
    ...
    def add_circuit_breaker(
        ...
        Returns:
            The builder instance for chaining
        """
        add_circuit_breaker_middleware(self.services, self.registry, options, event_types)
        return self
