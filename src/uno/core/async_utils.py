...
async def to_async(func: Callable[..., T | Awaitable[T]], *args: Any, **kwargs: Any) -> T:
    """
...
class FunctionHandlerAdapter:
    ...
    def __init__(self, func: Callable[[EventHandlerContext], Result[Any, Exception] | Awaitable[Result[Any, Exception]]], 
                 event_type: str):
