...
class _Scope:
    ...
    async def _check_not_disposed(self, operation: str) -> None:
        ...
        if self._disposed:
            raise await DIScopeDisposedError.async_init(
