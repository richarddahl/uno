...
def discover_handlers(
    modules: list[dict[str, Any]], registry: EventHandlerRegistry | None = None
) -> list[Any]:
    ...
    for module_dict in modules:
        for name, obj in module_dict.items():
            ...
            if hasattr(obj, "_is_event_handler") and getattr(
                obj, "_is_event_handler", False
            ):
            ...
            if (
                ...
                and obj != EventHandler
                and hasattr(obj, "_is_event_handler")
                and getattr(obj, "_is_event_handler", False)
            ):
