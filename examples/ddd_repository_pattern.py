...
from uno.core.di.interfaces import RepositoryProtocol, DomainRepositoryProtocol
...
class OrderRepository(RepositoryProtocol[OrderModel]):
    ...
    async def get(self, order_id: str) -> Optional[OrderModel]:
        return await self.session.get(OrderModel, order_id)

    async def list(self, customer_id: Optional[str] = None) -> List[OrderModel]:
...
class DomainOrderRepository(DomainRepositoryProtocol[OrderEntity]):
    ...
    async def get(self, order_id: str) -> Optional[OrderEntity]:
    ...
    async def list(self, customer_id: Optional[str] = None) -> List[OrderEntity]:
